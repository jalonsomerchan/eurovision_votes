...
export const eurovision2026Contests: EurovisionContest[] = [
  ...
  },
  {
    ...
    songs: [
      ...
      { runningOrder: '05', country: 'Chequia', flag: 'CZ', artist: 'Daniel Žižka', song: 'CROSSROADS', directFinalist: true },
      ...
      { runningOrder: '08', country: 'Chipre', flag: 'CY', artist: 'Antigoni', song: 'JALLA', directFinalist: true },
      ...
      { runningOrder: '12', country: 'Ucrania', flag: 'UA', artist: 'Leléka', song: 'Ridnym', directFinalist: true },
