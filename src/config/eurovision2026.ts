...
export const eurovision2026Contests: EurovisionContest[] = [
  ...
  },
  {
    ...
    songs: [
      { runningOrder: '01', country: 'Dinamarca', flag: 'DK', artist: 'Søren Torpegaard Lund', song: 'Før Vi Går Hjem' },
      { runningOrder: '02', country: 'Alemania', flag: 'DE', artist: 'Sarah Engels', song: 'Fire' },
      { runningOrder: '03', country: 'Israel', flag: 'IL', artist: 'Noam Bettan', song: 'Michelle' },
      { runningOrder: '04', country: 'Bélgica', flag: 'BE', artist: 'ESSYLA', song: 'Dancing on the Ice' },
      { runningOrder: '05', country: 'Albania', flag: 'AL', artist: 'Alis', song: 'Nân' },
      { runningOrder: '06', country: 'Grecia', flag: 'GR', artist: 'Akylas', song: 'Ferto' },
      { runningOrder: '07', country: 'Ucrania', flag: 'UA', artist: 'LELÉKA', song: 'Ridnym' },
      { runningOrder: '08', country: 'Australia', flag: 'AU', artist: 'Delta Goodrem', song: 'Eclipse' },
      { runningOrder: '09', country: 'Serbia', flag: 'RS', artist: 'LAVINA', song: 'Kraj Mene' },
      { runningOrder: '10', country: 'Malta', flag: 'MT', artist: 'AIDAN', song: 'Bella' },
      { runningOrder: '11', country: 'República Checa', flag: 'CZ', artist: 'Daniel Zizka', song: 'CROSSROADS' },
      { runningOrder: '12', country: 'Bulgaria', flag: 'BG', artist: 'DARA', song: 'Bangaranga' },
      { runningOrder: '13', country: 'Croacia', flag: 'HR', artist: 'LELEK', song: 'Andromeda' },
      { runningOrder: '14', country: 'Gran Bretaña', flag: 'GB', artist: 'LOOK MUM NO COMPUTER', song: 'Eins, Zwei, Drei' },
      { runningOrder: '15', country: 'Francia', flag: 'FR', artist: 'Monroe', song: 'Regarde !' },
      { runningOrder: '16', country: 'Moldavia', flag: 'MD', artist: 'Satoshi', song: 'Viva, Moldova!' },
      { runningOrder: '17', country: 'Finlandia', flag: 'FI', artist: 'Linda Lampenius x Pete Parkkonen', song: 'Liekinheitin' },
      { runningOrder: '18', country: 'Polonia', flag: 'PL', artist: 'ALICJA', song: 'Pray' },
      { runningOrder: '19', country: 'Lituania', flag: 'LT', artist: 'Lion Ceccah', song: 'Sólo Quiero Más' },
      { runningOrder: '20', country: 'Suecia', flag: 'SE', artist: 'FELICIA', song: 'My System' },
      { runningOrder: '21', country: 'Chipre', flag: 'CY', artist: 'Antigoni', song: 'JALLA' },
      { runningOrder: '22', country: 'Italia', flag: 'IT', artist: 'Sal Da Vinci', song: 'Per Sempre Sì' },
      { runningOrder: '23', country: 'Noruega', flag: 'NO', artist: 'JONAS LOVV', song: 'YA YA YA' },
      { runningOrder: '24', country: 'Rumanía', flag: 'RO', artist: 'Alexandra Căpitănescu', song: 'Choke Me' },
      { runningOrder: '25', country: 'Austria', flag: 'AT', artist: 'COSMÓ', song: 'Tanzschein' },
    ],
  },
];
